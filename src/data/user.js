const INFO = {
	...
	homepage: {
		...
		description1: `I'm Harshit. I have a strong background in working with Distributed Backend Systems and I'm equally adept with Frontend and DevOps, having spent around 30 months as a Software Engineer at UnitedHealth Group and being a summer intern at Smith & Associates.
			Currently, I am pursuing my Masters at Rice University, where I am focusing on the exciting field of Systems & Security to expand my skill set and knowledge.`,
	...
	about: {
		...
		description: `
		I'm Harshit Khanna. I am currently pursuing my Master's in Computer Science with a specialization in Systems & Security at Rice University. Throughout my academic journey, I have delved into a wide range of courses such as Machine Learning, Database System Implementation, IoT Programming, Graduate Design and Analysis of Algorithms, and Deep Learning. These experiences have equipped me with a diverse skill set that spans both frontend and backend development.
		...
		As I look forward to the future, I am eager to leverage my expertise in Systems & Security, alongside my extensive software engineering background, to create impactful solutions and contribute meaningfully to the ever-evolving world of technology and innovation.
		`,
	},
	...
	education: {
		...
		description: `
		I am currently pursuing a Master of Science in Computer Science at Rice University. I started my program in August 2022 and am expected to graduate in December 2023. I originally planned specialized in Data Science, but I am now switching to Systems & Security because I find it more appealing and explorative. I have taken courses in Database System Implementation, IoT Programming, Machine Learning, and Deep Learning. I have also taken general courses to improve my core CS skills, such as Graduate Analysis of Algorithms and Web Development.
	...
	projects: [
		...
		},
		{
			title: "Portfolio",
			description:
				"My portfolio (this website) built with React without any UI libraries",
			logo: "https://cdn.jsdelivr.net/npm/programming-languages-logos/src/typescript/typescript.png",
			linkText: "View Project",
